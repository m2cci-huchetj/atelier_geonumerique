...
var map = L.map('map').setView([44.557809, 4.752478], 12);
...
var orthophotoBounds = [
    [44.513415582, 4.686039959], // southwest corner
    [44.596206285, 4.801828317] // northeast corner 
];

var orthophoto2025 = L.imageOverlay('images/orthophoto_montelimar_2025.png', orthophotoBounds, {
    opacity: 0.7,
    className: 'orthophoto-layer'
});

var orthophoto2020 = L.imageOverlay('images/orthophoto_montelimar_2020.png', orthophotoBounds, {
    opacity: 0.7,
    className: 'orthophoto-layer'
});
...
(async () => {
  geojsonFeature = await loadGeoJSON('data/lcz_web_montelimar_wgs84.geojson');
})();
